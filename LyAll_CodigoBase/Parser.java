...
import Batiziño.ArbolSintactico.*;
...
public class Parser {
    ...
    final int ifx=1, thenx=2, elsex=3, beginx=4, endx=5, printx=6, semi=7,
            ...
            Resta = 14, Multi = 15, Div = 16, doublex = 17, longx = 18, whilex = 19, dox = 20;
...
/*     public static void main(String[] args){
    ...
    public Statx S() { //return statement
        switch(tknCode) {
            ...
            //+++++++++++++++++++++++++++++++++++++++++++++++
            case whilex: // Añadido para el while
                Expx ew;
                Statx sw;
                eat(whilex, "while");
                ew = E();
            ...
            default: error(token, "(if | begin | id | print | while | do )");
                return null;
        }
    }
    ...
    public int stringToCode(String t) {
        ...
        switch(t) {
            ...
            case "while": codigo = 19; break; // Añadido para el while
            case "do": codigo = 20; break; // Añadido para el do
            case ";": codigo=7; break;
            case "+": codigo=8; break;
            //---------------------------
